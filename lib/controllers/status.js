...
module.exports = {
    ...
    listUserStatuses: function listStatus (req, res) {
    ...
    userTeamStatuses: function listUserStatusesForTeam (req, res) {
        var query = {
    ...
    teamStatuses: function listStatusesForTeam (req, res) {
        var query = {
            teamId: req.params.teamId
        };
